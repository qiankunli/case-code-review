...
Instead, use **GitHub Private Vulnerability Reporting** — go to the [Security Advisories](https://github.com/qiankunli/case-code-review/security/advisories/new) page and submit a new advisory with the details below.
